export default function Projects() {
  return (
    <section id="projects" className="py-20 px-8 md:px-20 bg-black/10">
      <h3 className=" text-hero font-extrabold tracking-tight mb-6 leading-tight text-center text-center ">Projects</h3>
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="bg-card backdrop-blur-xs p-6 rounded-xl shadow-glass hover:shadow-lg transition-all duration-300">
          <h4 className="text-2xl font-semibold mb-2 text-white">Venue Booking System</h4>
